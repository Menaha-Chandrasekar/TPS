...
func init() {
// Connect to MongoDB
clientOptions := options.Client().ApplyURI("mongodb://localhost:27017/?retryWrites=true&connectTimeoutMS=10000")
...
collection = database.Collection("tokens1") // Replace "tokens" with your collection name
}
...
_, err := collection.InsertOne(context.TODO(), map[string]interface{}{"token": token,"Name": "Menaha", "ID":45, "Place":"CBE"})
if err != nil {
